...
const ArtItem = () => {
    return (
        <div className="flex-1 flex">
            <div className="mx-auto max-w-[1900px] py-10 px-16 flex-1 bg-red-200 flex relative">
                <div className="w-full h-full bg-red-900 relative rounded-xl overflow-hidden">
                    <Image
